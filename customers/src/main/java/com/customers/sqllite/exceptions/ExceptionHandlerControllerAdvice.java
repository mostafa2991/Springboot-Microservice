...
public class ExceptionHandlerControllerAdvice {
    ...
    public @ResponseBody
    ExceptionResponse handleException(final NotFoundException exception,
    ...
    public @ResponseBody
    ExceptionResponse handleException(final BadUrlException exception,
                                      final HttpServletRequest request) {
    ...
    private ExceptionResponse setErrorProperties(ExceptionResponse error,
